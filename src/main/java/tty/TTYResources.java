...
public class TTYResources extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][]{
                ...
                {"Initializing programName", "Initializing {0} ..."},
                ...
                {"is not a valid thread id", "\"{0}\" is not a valid thread name or id."},
                ...
                {"Debugger class and arguments must be specified", "Debugger class and arguments must be specified"},
                {"Method arguments:", "Method arguments:"},
                {"Method description", "inv_count {0} running {1} {2}"},
                {"Method entered:", "Method entered: "},
                {"Method exited:", "Method exited"},
                {"Method exitedValue:", "Method exited: return value {0}, "},
                {"Method invoke dump", "\tstart {0} end {1} duration {2}\tthread ''{3}''\treturned\t{4}"},
                ...
                {"Trace first", "Use trace command first."},
                ...
                {"trace silent method exit in effect for", "trace silent method exit in effect for {0}"},
                {"trace silent method exits in effect", "trace silent method exits in effect"},
                {"trace silent methods in effect", "trace silent methods in effect"},
                ...
                {"Usage: kill <thread> <throwable>", "Usage: kill <thread> <throwable>"},
                {"Usage: stats", "Usage: stats [methods|fields|all] [enable|disable|by] [methodName|ID|executionCount|start|end|duration|returnValue] [rev]"},
                ...
                {"zz help text",
                        "** command list **\n" +
                                ...
                                "thread <thread>        -- set default thread\n" +
                                "suspend [thread(s)]    -- suspend threads (default: all)\n" +
                                "resume [thread(s)]     -- resume threads (default: all)\n" +
                                "where [<thread> | all] -- dump a thread's stack\n" +
                                "wherei [<thread> | all]-- dump a thread's stack, with pc info\n" +
                                ...
                                "stats [methods|fields|all] [enable|disable|by <order>]\n" +
                                "\n" +
                                ...
                                "\n" +
                                "monitor <command>         -- execute command each exitTime the program stops\n" +
                                "monitor                   -- list monitors\n" +
                                "unmonitor <monitor#>      -- delete a monitor\n" +
                                "read <filename>           -- read and execute a command file\n" +
                                "\n" +
                                "lock <expr>               -- print lock info for an object\n" +
                                "threadlocks [thread]   -- print lock info for a thread\n" +
                                "\n" +
                                ...
                                "<thread>: thread id or name as reported in the 'threads' command\n" +
                                "<expr>: a Java(TM) Programming Language expression.\n" +
                                "Most common syntax is supported.\n" +
                                "<order>:\n" +
                                "\t for methods: [methodName|ID|executionCount|start|end|duration|returnValue] [rev]\n" +
                                "\n" +
