...
public class MessageOutput {
     ...
     * This is loaded by TTY2.main() at start-up
     */
     ...
     * TTY2.monitorCommand()
     * TTY2.TTY2() (for the '!!' command only)
    ...
    static void printPrompt() {
        ...
        if (threadInfo == null) {
            ...
            System.out.print
                    (MessageOutput.format("jdb prompt thread abc and current stack frame",
                            new Object[]{
                                    threadInfo.getThread().name(),
                                    threadInfo.getCurrentFrameIndex() + 1}));
        }
        System.out.flush();
    }
}
